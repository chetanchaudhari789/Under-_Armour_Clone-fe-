...
import { stringifyPrice } from "@/shared/utils/helper/helper";
          ...
          <div key={i}>
            <div className={css["item"]}>
              <div className={css["item-img"]}>
                <Link
                  href={`/product/${item.category}/${item.subcategory}/${item.id}?c=${item.color}`}
                >
                ...
                <div className={`${css["item-props"]} sm-dt-hide`}>
                  ...
                  <div className={css["other-info"]}>
                    ...
                    >
                      ...
                      <div>{stringifyPrice(item.price)}</div>
                    </div>
                  </div>
                  <ProductQty
...
const BagContent = ({ setCustomQty, bag, totalItems, removeItemFromBag,openLogin,openRegister }) => {
  return (
    <div className={css["bag-content"]}>
      <div className={css["reg-benefits"]}>
        <div className={css["options"]}>
          <Variant1 buttonText="Register" style={{ width: "100%" }} onClick={openRegister} />
          <Variant1 buttonText="Log In" style={{ width: "100%" }} onClick={openLogin}/>
        </div>
